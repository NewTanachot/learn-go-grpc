...
const (
	Transfer_GetProduct_FullMethodName    = "/Transfer/GetProduct"
	Transfer_StreamProduct_FullMethodName = "/Transfer/StreamProduct"
	Transfer_StreamOrder_FullMethodName   = "/Transfer/StreamOrder"
	Transfer_StreamAll_FullMethodName     = "/Transfer/StreamAll"
)
...
func (c *transferClient) GetProduct(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Product, error) {
	out := new(Product)
	err := c.cc.Invoke(ctx, Transfer_GetProduct_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transferClient) StreamProduct(ctx context.Context, in *OrderArray, opts ...grpc.CallOption) (Transfer_StreamProductClient, error) {
	stream, err := c.cc.NewStream(ctx, &Transfer_ServiceDesc.Streams[0], Transfer_StreamProduct_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transferClient) StreamOrder(ctx context.Context, opts ...grpc.CallOption) (Transfer_StreamOrderClient, error) {
	stream, err := c.cc.NewStream(ctx, &Transfer_ServiceDesc.Streams[1], Transfer_StreamOrder_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transferClient) StreamAll(ctx context.Context, opts ...grpc.CallOption) (Transfer_StreamAllClient, error) {
	stream, err := c.cc.NewStream(ctx, &Transfer_ServiceDesc.Streams[2], Transfer_StreamAll_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _Transfer_GetProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Transfer_GetProduct_FullMethodName,
	}
